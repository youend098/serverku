...
# // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO VPN PREMIUM BY MF_youend ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}MF_youend® ${NC}${YELLOW}(${NC}${green}V 3.5${NC}${YELLOW})${NC}"
echo -e " ›TEAM   : MF_youend ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
echo -e "   .----------------------------------."
echo -e "   |\e[1;32m      SILAHKAN PILIH DOMAIN       \e[0m|"
echo -e "   '----------------------------------'"
...
#OpenVPN
wget https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/config/openvpn  chmod +x openvpn && ./openvpn
...
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Scrypt Dari MF_youend"
sleep 1
