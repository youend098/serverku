...
echo " ╚═╝     ╚═╝╚═╝            ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚═╝  ╚═══╝╚═════╝ "
echo ""
echo " -----------------STARTING THE SCRYPT MF_youend INSTALLATION-----------------"
sleep 2

# // Banner
echo "----------------------------------------------------------"
echo " WELCOME TO VPN PREMIUM BY MF_youend (Stable Edition)"
echo " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo "----------------------------------------------------------"
echo " ›AUTHOR : MF_youend® (V 3.5)"
echo " ›TEAM   : MF_youend ( 2025 )"
echo "----------------------------------------------------------"
echo ""
sleep 2
...
if [[ "$os_id" == "ubuntu" || "$os_id" == "debian" ]]; then
    ...
    echo "[ERROR] Your OS Is Not Supported ( $os_name )"
    exit 1
fi
...
# REPO    
REPO="https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/"
...
echo ""
echo " -------------------------------"
echo "     SILAHKAN PILIH DOMAIN      "
echo " -------------------------------"
echo "  1) Menggunakan Domain Sendiri "
echo "  2) Menggunakan Domain Script  "
echo " -------------------------------"
...
function make_folder_xray() {
    ...
    echo "echo 'Vps Config User Account'" >> /etc/user-create/user.log
}

function install_xray() {
    clear
    echo "Memasang Core Xray 1.8.1 Versi Terbaru"
    ...
    echo "Core Xray Berhasil Diinstal"
    ...
    sudo curl -fsSL https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
# Set zona waktu ke GMT+7 (Asia/Jakarta)
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime

# Nonaktifkan penerimaan variabel lingkungan dari SSH
...
wget -q https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/config/mf-tunnel && chmod +x mf-tunnel && ./mf-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/udp-custom/udp-custom.sh
...
wget https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/config/openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.com/youend098/serverku/refs/heads/main/files/issue.net
...
EOF
    ...
    echo "Menu Packet selesai"
}

# Restart layanan setelah install
...
echo " ╚═╝     ╚═╝╚═╝            ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚═╝  ╚═══╝╚═════╝ "
echo ""
echo " ----------------------------SCRIPT BY MF_youend-----------------------------"
echo ""
echo "" | tee -a log-install.txt
echo "Semua Instalasi Berjalan Sukses...Terimakasih Telah menggunakan Scrypt Dari MF_youend"
sleep 1
echo -ne "[ COMPLETED ] PENGINSTALAN SCRIPT SELESAI? "
reboot
