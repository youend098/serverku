...
# MENGHITUNG TOTAL WAKTU INSTALASI SCRIPT
start=$(date +%s)
secs_to_human() {
    echo "Installation time : $((${1} / 3600)) hours $(((${1} / 60) % 60)) minute's $((${1} % 60)) seconds"
}

# MEMERIKSA SEMUA PERSIAPAN INSTALASI
function print_ok() {
    echo " $1"
}
...
echo ""
read -p "Masukkan Subdomain Anda : " domain_input

# Pastikan direktori tujuan
mkdir -p /var/lib/kyt
mkdir -p /etc/xray
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"t.me/MF_youend"}]]}' 
